...
#set_property -dict {PACKAGE_PIN AD12 IOSTANDARD LVDS} [get_ports {sys_clk_p}]; #IO_L12P_T1_MRCC_33 Sch=sys_clk_p
#set_property -dict {PACKAGE_PIN AD11 IOSTANDARD LVDS} [get_ports {sys_clk_n}]; #IO_L12N_T1_MRCC_33 Sch=sys_clk_n
#create_clock -period 5.000 -name clk_p -waveform {0.000 2.500} -add [get_ports sys_clk_p];
#create_clock -period 5.000 -name clk_n -waveform {2.500 5.000} -add [get_ports sys_clk_n];
...
set_property -dict {PACKAGE_PIN AA12 IOSTANDARD LVCMOS15} [get_ports {usr_btn[0]}]; # Right
set_property -dict {PACKAGE_PIN AB12 IOSTANDARD LVCMOS15} [get_ports {usr_btn[1]}]; # Down
set_property -dict {PACKAGE_PIN AC6  IOSTANDARD LVCMOS15} [get_ports {usr_btn[2]}]; # Up
set_property -dict {PACKAGE_PIN AG5  IOSTANDARD LVCMOS15} [get_ports {usr_btn[3]}]; # Left
set_property -dict {PACKAGE_PIN  G12 IOSTANDARD LVCMOS25} [get_ports {usr_btn[4]}]; # Center
